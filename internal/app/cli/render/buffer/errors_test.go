...
func TestErrInvalidDimension_Code(t *testing.T) {
	t.Parallel()
	if ErrInvalidDimension.Code() != "RENDER.BUFFER.INVALID_DIMENSION" {
		t.Errorf("ErrInvalidDimension.Code() = %q, want RENDER.BUFFER.INVALID_DIMENSION", ErrInvalidDimension.Code())
	}
