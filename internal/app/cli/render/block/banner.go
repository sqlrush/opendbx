...
// Banner is the spec-0.13 stub for the banner block type. Render returns
// (nil, ErrUnsupportedNode) per the spec-0.13 D-3 contract (replaces R1
// panic path; R2 codex HIGH-5).
//
// TODO(spec-TBD): see development-roadmap.md; not yet on Stage 1 roadmap.
type Banner struct{}

// Render satisfies the RenderNode interface but returns the unsupported
// sentinel for this stub.
func (Banner) Render(_ Context) (buffer.Buffer, error) {
