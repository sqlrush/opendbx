...
// (was the old Toolcall stub) to production; spec-1.9b promotes ToolResult;
// spec-1.10 promotes CompactSummary. The remaining stubs preserve the
// spec-0.13 stub contract; future spec-1.x produces each.
//
