...
// Compact is the spec-0.13 stub for the compact block type. Render returns
// (nil, ErrUnsupportedNode) per the spec-0.13 D-3 contract (replaces R1
// panic path; R2 codex HIGH-5).
//
// TODO(spec-1.10): replace stub Render with real implementation; see spec-1.7 D-6 R2 D6 deferred-stub contract.
type Compact struct{}

// Render satisfies the RenderNode interface but returns the unsupported
// sentinel for this stub.
func (Compact) Render(_ Context) (buffer.Buffer, error) {
